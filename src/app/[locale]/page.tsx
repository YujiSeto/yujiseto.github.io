      ...
      <section id="skills" className="py-24 px-4 bg-secondary/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 sm:gap-6 max-w-5xl mx-auto">
            {skills.map((skill) => (
              <div key={skill.name} className="flex flex-col items-center justify-center gap-4 p-6 bg-card border border-border rounded-3xl shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group aspect-square sm:aspect-auto sm:h-40">
                <skill.icon className="w-10 h-10 text-accent group-hover:scale-110 transition-transform" />
                <span className="text-sm sm:text-base font-bold text-foreground text-center">{skill.name}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="py-20 px-4 border-t border-border bg-card">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="text-center md:text-left">
            ...
            <p className="text-foreground/60 max-w-xs font-medium italic">
              {footerT("tagline")}
            </p>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end gap-6">
            <div className="flex gap-6">
              <a href="https://github.com/YujiSeto" target="_blank" className="p-3 bg-secondary text-foreground/70 rounded-full hover:text-accent hover:bg-secondary/80 transition-all">
              ...
              <a href="https://www.linkedin.com/in/yujiseto/" target="_blank" className="p-3 bg-secondary text-foreground/70 rounded-full hover:text-accent hover:bg-secondary/80 transition-all">
              ...
              <a href="mailto:rodrigo.yuji.seto@gmail.com" className="p-3 bg-secondary text-foreground/70 rounded-full hover:text-accent hover:bg-secondary/80 transition-all">
